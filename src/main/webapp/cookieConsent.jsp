<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    if(session.getAttribute("cookieConsent") == null){
    	out.print("<div class='fixed-bottom note note-warning w-50'>");
    	...
    	out.print("<button name='consent' type='submit' class='btn btn-success btn-rounded' value='yes'>Accept</button>");
